...
/**
 * Renders assistant chat replies as Markdown (GitHub-flavored). Styling is done
 * with Tailwind descendant selectors on the default-rendered elements — no
 * `dangerouslySetInnerHTML`, and it stays on the app's black & white theme.
 */
...
const MD_STYLES = cn(
  ...
  "[&_ul]:my-2 [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:my-2 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:mt-0.5",
  ...
  "[&_pre]:my-2 [&_pre]:overflow-x-auto [&_pre]:rounded-lg [&_pre]:bg-foreground/10 [&_pre]:p-3 [&_pre]:text-xs",
...
export function MarkdownMessage({
  ...
  return (
    <div className={cn(MD_STYLES, className)}>
